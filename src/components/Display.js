      ...
      >
        <form onSubmit={handleSubmit}>
          <TypedComponent
            ...
            strings={[
              "Welcome to The Wasteland. It's not much but it's what we call home now.",
              'Here you can traverse and interact with other players in different zones. If you look around you might find something interesting, like doubloon or a rat-on-a-stick!',
              'Have fun exploring!',
            ]}
          />
